...
import { NavController, NavParams, ModalController,Content,Platform,ViewController } from 'ionic-angular';
...
datedisplay1;
  ...
  constructor(public viewCtrl : ViewController,public platform:Platform,public http : Http, public myJData : MyJsonDataProvider, public mod: ModalController, public calendar: Calendar,public alertCtrl: AlertController, public navCtrl: NavController, public navParams: NavParams) {
 ...
 for(let i=0; i<7;i++)
  ...
  ionViewDidLoad() {
   ...
   /*  this.content.ionScroll.subscribe(($event) => {
                ...
                if(this.scrollAmount>=60)
                  {
                    alert("ok");
                  }
            }); */
        console.log('ionViewDidLoad CalenderdisplayPage');
        let yOffset = document.getElementById('eighthEle').offsetTop;
