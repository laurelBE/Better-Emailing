...
/**
 * Generated class for the ActionRequestedPage page.
 *
...
@Component({
  selector: 'page-action-requested',
  templateUrl: 'action-requested.html',
})
export class ActionRequestedPage {

  messageList = [];

  public email : String ="sneha@eproductivite.com";
  public folder : String  = "Action Requested";
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ActionRequestedPage');
  }
